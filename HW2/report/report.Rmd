...
Table 2 computes the least squares model. The RSS value determines on average, how much the actual sales deviates from the true regression. Here, RSS is 3.26, meaning, on average, the actual sales deviates from the true regression by 3.26 units.
