...
<<scatterplot, fig.width=7, fig.height=5, echo=FALSE, fig.align='center', fig.cap="Scatterplot with fitted regression line", fig.pos="H">>=
library(png)
library(grid)
scatterplot <- readPNG('scatterplot-tv-sales.png')
